...
export class GanttComponent implements AfterContentInit, OnInit, OnDestroy {
    tasks =      [ 
                        {
                            "Id": 1000,
            ...
            headerConfig: {
                bottom: {
                    ...
                    renderer: function (start) {
                        let dayName = Ext.Date.dayNames[start.getDay()];
                ...
                middle: {
                    ...
                    renderer: function (start, end, cfg) {
                        let dayName = (Ext.Date.dayNames[start.getDay()]).substring(0, 3);
                        let dayNumber = Ext.Date.format(start, "d");
                        let monthName = (Ext.Date.monthNames[start.getMonth()]).substring(0, 3);
                        let yearNumber = Ext.Date.format(start, "Y");
